...
clojure.browser.event.IEventType = (function (){var obj14030 = {};return obj14030;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3595__auto__ = this$;if(and__3595__auto__)
...
{var x__4244__auto__ = (((this$ == null))?null:this$);return (function (){var or__3607__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4244__auto__)]);if(or__3607__auto__)
{return or__3607__auto__;
} else
{var or__3607__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3607__auto____$1)
...
return (function (p__14031){var vec__14032 = p__14031;var k = cljs.core.nth.call(null,vec__14032,(0),null);var v = cljs.core.nth.call(null,vec__14032,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__14033){var vec__14034 = p__14033;var k = cljs.core.nth.call(null,vec__14034,(0),null);var v = cljs.core.nth.call(null,vec__14034,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
} else
