...
reagent.impl.batching.next_tick = ((cljs.core.not.call(null,reagent.impl.util.is_client))?reagent.impl.batching.fake_raf:(function (){var w = window;var or__3607__auto__ = (w["requestAnimationFrame"]);if(cljs.core.truth_(or__3607__auto__))
{return or__3607__auto__;
} else
{var or__3607__auto____$1 = (w["webkitRequestAnimationFrame"]);if(cljs.core.truth_(or__3607__auto____$1))
{return or__3607__auto____$1;
} else
{var or__3607__auto____$2 = (w["mozRequestAnimationFrame"]);if(cljs.core.truth_(or__3607__auto____$2))
{return or__3607__auto____$2;
} else
{var or__3607__auto____$3 = (w["msRequestAnimationFrame"]);if(cljs.core.truth_(or__3607__auto____$3))
...
var n__4477__auto__ = a.length;var i = (0);while(true){
if((i < n__4477__auto__))
{var c_15985 = (a[i]);if(cljs.core.truth_((c_15985["cljsIsDirty"])))
{(c_15985["forceUpdate"])();
} else
{}
{
...
reagent.impl.batching.run_funs = (function run_funs(a){var n__4477__auto__ = a.length;var i = (0);while(true){
if((i < n__4477__auto__))
{(a[i]).call(null);
{
var G__15987 = (i + (1));
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4184__auto__,writer__4185__auto__,opt__4186__auto__){return cljs.core._write.call(null,writer__4185__auto__,"reagent.impl.batching/RenderQueue");
});
...
reagent.impl.batching.is_reagent_component = (function is_reagent_component(c){var G__15989 = c;var G__15989__$1 = (((G__15989 == null))?null:(G__15989["props"]));var G__15989__$2 = (((G__15989__$1 == null))?null:(G__15989__$1["argv"]));return G__15989__$2;
});
...
reagent.impl.batching.dispose = (function dispose(c){var G__15991_15992 = (c["cljsRatom"]);var G__15991_15993__$1 = (((G__15991_15992 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__15991_15992));return reagent.impl.batching.mark_rendered.call(null,c);
});
