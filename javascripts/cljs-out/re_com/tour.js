...
return (function (p1__18087_SHARP_,p2__18088_SHARP_){return cljs.core.assoc.call(null,p1__18087_SHARP_,p2__18088_SHARP_,reagent.core.atom.call(null,false));
});})(tour_map))
,tour_map,tour_spec);
});
/**
...
*/
re_com.tour.initialise_tour = (function initialise_tour(tour){return cljs.core.doall.call(null,(function (){var iter__4346__auto__ = (function iter__18093(s__18094){return (new cljs.core.LazySeq(null,(function (){var s__18094__$1 = s__18094;while(true){
var temp__4423__auto__ = cljs.core.seq.call(null,s__18094__$1);if(temp__4423__auto__)
{var s__18094__$2 = temp__4423__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__18094__$2))
{var c__4344__auto__ = cljs.core.chunk_first.call(null,s__18094__$2);var size__4345__auto__ = cljs.core.count.call(null,c__4344__auto__);var b__18096 = cljs.core.chunk_buffer.call(null,size__4345__auto__);if((function (){var i__18095 = (0);while(true){
if((i__18095 < size__4345__auto__))
{var step = cljs.core._nth.call(null,c__4344__auto__,i__18095);cljs.core.chunk_append.call(null,b__18096,cljs.core.reset_BANG_.call(null,step.call(null,tour),false));
{
var G__18097 = (i__18095 + (1));
i__18095 = G__18097;
continue;
}
} else
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18096),iter__18093.call(null,cljs.core.chunk_rest.call(null,s__18094__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18096),null);
}
} else
{var step = cljs.core.first.call(null,s__18094__$2);return cljs.core.cons.call(null,cljs.core.reset_BANG_.call(null,step.call(null,tour),false),iter__18093.call(null,cljs.core.rest.call(null,s__18094__$2)));
}
} else
{return null;
}
...
});return iter__4346__auto__.call(null,new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
})());
});
/**
...
*/
re_com.tour.make_tour_nav = (function make_tour_nav(tour){var on_first_button = cljs.core._EQ_.call(null,cljs.core.deref.call(null,new cljs.core.Keyword(null,"current-step","current-step",-2023410137).cljs$core$IFn$_invoke$arity$1(tour)),(0));var on_last_button = cljs.core._EQ_.call(null,cljs.core.deref.call(null,new cljs.core.Keyword(null,"current-step","current-step",-2023410137).cljs$core$IFn$_invoke$arity$1(tour)),(cljs.core.count.call(null,new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour)) - (1)));return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"hr","hr",1377740067),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.call(null,re_com.box.flex_child_style.call(null,"none"),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin","margin",-995903681),"10px 0 10px"], null))], null)], null),((on_first_button)?null:new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.buttons.button,new cljs.core.Keyword(null,"label","label",1718410804),"Previous",new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (on_first_button,on_last_button){
return (function (event){re_com.tour.prev_tour_step.call(null,tour);
return null;
...
return (function (event){if(on_last_button)
